...
library(ggplot2)
library(cowplot)
output.dir = '.../supCPM-main/supCPM_MATLAB/results/' # the location of output file
figure.dir = '.../supCPM-main/supCPM_MATLAB/results/figures/' # the location of figure file
# color
