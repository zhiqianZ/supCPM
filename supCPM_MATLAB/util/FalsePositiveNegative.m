...
classdef FalsePositiveNegative
    ...
    methods
        ...
        function html=htmlDetails(this)
            N=size(this.t, 1);
            if N>0
                html='';
                td='<td align="right">';
                ...
                for i=1:N
                    ...
                    if r.reduction ~= reduction ...
                        ...
                        html=[html b breakHdr breakBody hdr];
                    end
                    html=[html '<tr>'...
    ...
    methods(Static)
        function [fig, this, legendH, classHtmls, ttlFound]=Plot(...
            ...
            if isempty(fileNameOrObj)
                fileNameOrObj=fullfile(...
                    ...
                    'ustTest.pair', 'samusikImported_29D', ...
            ...
            if length(plotType)>1
                ...
                pu=PopUp('Building false positvie/negative plots',  ...
                    'south east+', 'Computing...',...
            ...
            function popupMenu(h, newAx)
                ...
                jm.addSeparator;
                Gui.NewMenuItem(jm, 'Browse details', ...
                    @(h,e)browseDetails(false));
                Gui.NewMenuItem(jm, 'Browse details & plot', ...
                    @(h,e)browseDetails(true));
                jm.show(h, 15, 15);    
            end
            
            function browseDetails(figToo)
                html=this.htmlDetails;
                if figToo
        ...
        function [H, J]=MoreBtn(fig, callback)
            ...
            [H,J]=Gui.ImageLabel('  Weighing more...', 'plusMinus.png', ...
                ['<html>See additional false positive and'...
                ' negative plots<hr>' Html.ImgXy(...
                'wayneMoore1.png', [], .91)...
                '</html>'], callback, fig, 1, 1, true);
            J.setBackground(java.awt.Color(1, 1, .7))
            if BasicMap.Global.highDef
                p=get(H, 'position');
                set(H, 'position', [p(1) p(2) p(3)*.5 p(4)]);
            end
        end
