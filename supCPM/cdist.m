...
%      for  i = 1:n
%          for j = 1:n
%           curr_dim(i,j) = find_dim(r,dim,sqrt(D(i,j))); % find the estimated dimension at the scale r
%          end
%      end
%      
     r0 = [-1;r];
