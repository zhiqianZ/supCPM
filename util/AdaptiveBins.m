...
classdef AdaptiveBins<handle
    ...
    methods
        ...
        function [f,o,p,r]=fMeasure(this, teachChoices, studChoices)
            ...
            [f,o,p,r]=AdaptiveBins.F_measure(teachCnts, studCnts);
    ...
    methods(Static)
        ...
        function [f, percentOverlap,p,r]=F_measure(teachCnts, studCnts)
            tCnt=sum(teachCnts);
            sCnt=sum(studCnts);
            cnt=tCnt+sCnt;
            tCntRatio=tCnt/cnt;
            ...
            p=Clusters.Precision(recallCnt,sCnt);
            r=Clusters.Recall(recallCnt,tCnt);
        end
